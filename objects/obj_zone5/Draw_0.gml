if(hovering){
	...
	if(taken){
		if(rand==1){
			draw_text_color(x+33,y+70,@"The ___ zone has decided 
...
to kill any SOLDIERS that enter it.",150,150,150,1,1);
			...
			draw_text_color(x+33,y+70,@"The ___ zone has decided 
to reward whoever captures it first with 1 point.",150,150,150,1,1);
		}
	}
	else{
		draw_text_color(x+33,y+70,@"The ___ zone gives a
